...
namespace MusicStore.Areas.Admin.Controllers
{
    ...
    public class AlbumsController : Controller
    {
        ...
        // GET: Admin/Albums
        public IActionResult Index(string title, int genreID = 0, int artistID = 0)
        {
            ...
            listAlbumsVM.Albums = albums.ToList();

            listAlbumsVM.Genres =
                new SelectList(_context.Genres.OrderBy(g => g.Name),
                        "GenreID", "Name");
            listAlbumsVM.Artists =
                new SelectList(_context.Artists.OrderBy(a => a.Name),
                        "ArtistID", "Name");
